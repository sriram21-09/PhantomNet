  ...
  - generic [ref=e43]:
    ...
    - generic [ref=e81]:
      ...
      - generic [ref=e136]:
        ...
        - generic [ref=e166]:
          - generic [ref=e167]:
            - heading "Analyst Approval Rate" [level=4] [ref=e168]
            - paragraph [ref=e169]: PIPELINE EFFICIENCY RATING
          - img [ref=e171]:
            - generic [ref=e174]: 0%
            - text: APPROVED RATIO
          - generic [ref=e175]:
        ...
        - generic [ref=e185]:
          - generic [ref=e186]:
            - heading "Generation Timeline" [level=4] [ref=e187]
            - paragraph [ref=e188]: NO HISTORY RECORDED
          - generic [ref=e189]:
            - img [ref=e190]:
              - generic [ref=e191]: "4"
              - generic [ref=e193]: "3"
              ...
              - generic [ref=e199]: "0"
            - generic [ref=e201]:
              - generic [ref=e202]: NO_GENERATION_HISTORY
              - paragraph [ref=e203]: Generate playbook response rules to view creation trends.
    - generic [ref=e204]:
      - generic [ref=e205]:
        - heading "ATT&CK Techniques" [level=2] [ref=e206]
        - generic [ref=e207]: 12 MAPPED
      - generic [ref=e208]:
        - generic [ref=e209]:
          - generic:
            - generic: Password Guessing
            - generic: Credential Access
          - link "T1110.001" [ref=e210] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1110/001/
        - generic [ref=e215]:
          - generic:
            - generic: Spearphishing Attachment
            - generic: Initial Access
          - link "T1566.001" [ref=e216] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1566/001/
        - generic [ref=e221]:
          - generic:
            - generic: PowerShell
            - generic: Execution
          - link "T1059.001" [ref=e222] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1059/001/
        - generic [ref=e227]:
          - generic:
            - generic: Scheduled Task
            - generic: Persistence
          - link "T1053.005" [ref=e228] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1053/005/
        - generic [ref=e233]:
          - generic:
            - generic: File and Directory Discovery
            - generic: Discovery
          - link "T1083" [ref=e234] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1083/
        - generic [ref=e239]:
          - generic:
            - generic: SMB/Windows Admin Shares
            - generic: Lateral Movement
          - link "T1021.002" [ref=e240] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1021/002/
        - generic [ref=e245]:
          - generic:
            - generic: DNS
            - generic: Command and Control
          - link "T1071.004" [ref=e246] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1071/004/
        - generic [ref=e251]:
          - generic:
            - generic: Exfiltration Over C2
            - generic: Exfiltration
          - link "T1048.003" [ref=e252] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1048/003/
        - generic [ref=e257]:
          - generic:
            - generic: File Deletion
            - generic: Defense Evasion
          - link "T1070.004" [ref=e258] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1070/004/
        - generic [ref=e263]:
          - generic:
            - generic: Exploitation for Privilege Escalation
            - generic: Privilege Escalation
          - link "T1068" [ref=e264] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1068/
        - generic [ref=e269]:
          - generic:
            - generic: Data Encrypted for Impact
            - generic: Impact
          - link "T1486" [ref=e270] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1486/
        - generic [ref=e275]:
          - generic:
            - generic: Automated Collection
            - generic: Collection
          - link "T1119" [ref=e276] [cursor=pointer]:
            - /url: https://attack.mitre.org/techniques/T1119/
    - generic [ref=e281]:
      - generic [ref=e282]:
        - heading "Detection Rules" [level=2] [ref=e283]
        - generic [ref=e284]: SNORT / SIGMA
      - generic [ref=e285]:
        - generic [ref=e286]:
          - tablist "Rule syntax selection" [ref=e287]:
            - tab "Snort" [selected] [ref=e288] [cursor=pointer]
            - tab "Sigma" [ref=e292] [cursor=pointer]
          - button "Copy" [ref=e296] [cursor=pointer]
        - generic [ref=e300]:
          - generic [ref=e301]:
            - generic [ref=e302]: "1"
            - generic [ref=e303]: alert tcp $EXTERNAL_NET any -> $HOME_NET 445 (msg:"ET EXPLOIT Possible SMB Brute Force"; flow:to_server,established; content:"|ff|SMB"; depth:4; content:"|73 00 00 00|"; distance:0; threshold:type both, track by_src, count 5, seconds 60; classtype:attempted-admin; sid:2024001; rev:3; )
          - generic [ref=e304]: "2"
          - generic [ref=e306]:
            - generic [ref=e307]: "3"
            - generic [ref=e308]: "# Secondary detection for lateral movement"
          - generic [ref=e309]:
            - generic [ref=e310]: "4"
            - generic [ref=e311]: alert tcp $HOME_NET any -> $HOME_NET 135 (msg:"INTERNAL Lateral Movement via DCOM"; flow:to_server,established; content:"|05|"; depth:1; content:"|0b|"; distance:1; within:1; classtype:attempted-admin; sid:2024002; rev:1; )
        - generic [ref=e312]:
          - generic [ref=e313]: Snort IDS Rule
          - generic [ref=e314]: 4 lines
    - generic [ref=e315]:
      - generic [ref=e316]:
        - heading "Generated Playbooks" [level=2] [ref=e317]
        - generic [ref=e318]: 0 PLAYBOOKS
      - generic [ref=e319]:
        - button "All 0" [ref=e320] [cursor=pointer]:
          - text: All
          - generic [ref=e321]: "0"
        - button "Draft 0" [ref=e322] [cursor=pointer]:
          - text: Draft
          - generic [ref=e323]: "0"
        - button "Approved 0" [ref=e324] [cursor=pointer]:
          - text: Approved
          - generic [ref=e325]: "0"
        - button "Rejected 0" [ref=e326] [cursor=pointer]:
          - text: Rejected
          - generic [ref=e327]: "0"
      - generic [ref=e328]:
        - textbox "SEARCH PLAYBOOKS..." [ref=e330]
        - generic [ref=e331]:
          - generic [ref=e332]: "SEVERITY:"
      ...
      - generic [ref=e340]:
        - heading "System Connection Failure" [level=3] [ref=e343]
        - paragraph [ref=e344]: "JSON.parse: unexpected end of data at line 1 column 1 of the JSON data"
        - button "Retry Connection" [ref=e345] [cursor=pointer]
    - generic "Notifications":
      - alert [ref=e348]:
        - generic [ref=e349]:
          - generic [ref=e352]:
            - strong [ref=e353]: Matrix Load Failed
            - generic [ref=e354]: "JSON.parse: unexpected end of data at line 1 column 1 of the JSON data"
          - button "Dismiss notification" [ref=e355] [cursor=pointer]
      - alert [ref=e358]:
        - generic [ref=e359]:
          - generic [ref=e362]:
            - strong [ref=e363]: Connection Failed
            - generic [ref=e364]: "JSON.parse: unexpected end of data at line 1 column 1 of the JSON data"
          - button "Dismiss notification" [ref=e365] [cursor=pointer]
      - alert [ref=e368]:
        - generic [ref=e369]:
          - generic [ref=e372]:
            - strong [ref=e373]: Matrix Load Failed
            - generic [ref=e374]: "JSON.parse: unexpected end of data at line 1 column 1 of the JSON data"
          - button "Dismiss notification" [ref=e375] [cursor=pointer]
      - alert [ref=e378]:
        - generic [ref=e379]:
          - generic [ref=e382]:
            - strong [ref=e383]: Connection Failed
            - generic [ref=e384]: "JSON.parse: unexpected end of data at line 1 column 1 of the JSON data"
          - button "Dismiss notification" [ref=e385] [cursor=pointer]
```
