...
class FeatureExtractor:
    ...
    def encode_protocol(self, protocol: str) -> list:
        ...
        p = protocol.upper()
        return [1 if p == "TCP" else 0, 1 if p == "UDP" else 0, 1 if p == "ICMP" else 0]
    ...
    def generate_labeled_sample(self):
        ...
        return [
            ...
            {
                "start": "2025-12-20 10:05:00",
                "end": "2025-12-20 10:05:01",
                "proto": "UDP",
                "src": "10.0.0.5",
                "dst": "8.8.8.8",
                "label": "BENIGN",
            ...
            {
                "start": "2025-12-20 10:10:00",
                "end": "2025-12-20 10:10:00",
                "proto": "TCP",
                "src": "192.168.1.100",
                "dst": "192.168.1.200",
                "label": "MALICIOUS",
