...
TARGETS = {"ssh": "10.0.2.31", "smtp": "10.0.2.30", "backend": "10.0.3.40"}
PORTS = {
...
class AttackSimulator:
    ...
    def validate_detection(self):
        ...
        try:
            ...
            logging.error(
                f"[-] Could not connect to Backend API at {BACKEND_API}. Ensure the topology is running and backend is up."
            )
        except Exception as e:
