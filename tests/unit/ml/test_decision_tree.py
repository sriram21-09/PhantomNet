...
class TestResponseDecisionTree:
    ...
    def test_benign_traffic_log(self, decision_tree):
        ...
        result = decision_tree.decide(
            prediction=0, confidence=0.1, anomaly_score=0.1, threat_score=0.0
        )
        assert result == "LOG"
    ...
    def test_benign_traffic_high_anomaly(self, decision_tree):
        ...
        result = decision_tree.decide(
            prediction=0, confidence=0.1, anomaly_score=0.9, threat_score=0.0
        )
        assert result == "LOG"
    ...
    def test_attack_low_confidence_throttle(self, decision_tree):
        ...
        result = decision_tree.decide(
            prediction=1, confidence=0.5, anomaly_score=0.1, threat_score=0.0
        )
    ...
    def test_attack_high_severity_block(self, decision_tree):
        ...
        result = decision_tree.decide(
            prediction=1, confidence=0.9, anomaly_score=0.9, threat_score=0.9
        )
        assert result == "BLOCK"
    ...
    def test_attack_medium_severity_deceive(self, decision_tree):
        ...
        result = decision_tree.decide(
            prediction=1, confidence=0.7, anomaly_score=0.6, threat_score=0.0
        )
    ...
    def test_attack_fallback_throttle(self, decision_tree):
        ...
        result = decision_tree.decide(
            prediction=1, confidence=0.9, anomaly_score=0.1, threat_score=0.0
        )
        assert result == "THROTTLE"
    ...
    def test_custom_thresholds_initialization(self):
        ...
        result = dt.decide(
            prediction=1, confidence=0.7, anomaly_score=0.0, threat_score=0.0
        )
        assert result == "THROTTLE"
