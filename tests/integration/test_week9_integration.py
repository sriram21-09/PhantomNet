...
def inject_mock_sqlite_packet(src_ip, dst_port, payload="Mock BENIGN Payload", protocol="TCP", length=120):
    """
...
class TestWeek9Integration:
    ...
    def test_backend_health(self):
        ...
        try:
            ...
            pytest.skip("Backend is offline. Start the uvicorn server to run integration tests.")
    ...
    def test_ml_scoring_latency(self):
        ...
        assert latency < 6.0, f"Latency ({latency:.2f}s) exceeded acceptable 6s bounds (5s poll + 1s ML compute)."
    ...
    def test_advanced_pattern_detection(self):
        ...
        if resp.status_code == 200:
            ...
            if len(dbf_events) > 0:
                ...
                print("WARNING: Pattern Detector returned 0 events. Check database state.")
        else:
