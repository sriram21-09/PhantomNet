...
class ModelComparator:
    ...
    def compare_models(self, version_1: str, version_2: str) -> Dict[str, Any]:
        ...
        if not model_1 or not model_2:
            raise ValueError(
                f"One or both models not found in registry: {version_1}, {version_2}"
            )
    ...
    def generate_report(
        self, versions: List[str], output_path: str = "model_comparison_report.md"
    ):
        """
...
if __name__ == "__main__":
    ...
    v1 = registry.register_model(
        "ml_models/dummy.pkl", "DummyTest", bump_type="major", metadata=v1_meta
    )
    v2 = registry.register_model(
        "ml_models/dummy.pkl", "DummyTest", bump_type="minor", metadata=v2_meta
    )
    v3 = registry.register_model(
        "ml_models/dummy.pkl", "DummyTest", bump_type="patch", metadata=v3_meta
    )
